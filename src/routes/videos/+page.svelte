  ...
  <div class="app-container">
    ...
    <div class="text-center mt-8 opacity-80">
        ...
        <a href="{base}/blog" class="mt-4 rounded-full bg-white px-4 py-2.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-200">BLOG POSTS</a>
          ...
          <div class="opacity-95 grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-6 ml-5 mt-8 mr-5">
            <article class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 pb-8 pt-80 sm:pt-48 lg:pt-80">
              <img src="https://store-images.s-microsoft.com/image/apps.37935.9007199266245907.b029bd80-381a-4869-854f-bac6f359c5c9.91f8693c-c75b-4050-a796-63e1314d18c9?h=464" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover">
            ...
            <article class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 pb-8 pt-80 sm:pt-48 lg:pt-80">
                <img src="https://www.lifewire.com/thmb/wpgtzWwjSr6d8Obl11uQgg0pD4s=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/Twitter-and-X-4c4103f6bc3c42e0b7197b60a50317ca.jpg" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover">
                <div class="absolute inset-0 -z-10 bg-gradient-to-t from-gray-900 via-gray-900/40"></div>
                <div class="absolute inset-0 -z-10 rounded-2xl ring-1 ring-inset ring-gray-900/10"></div>
                ...
                <h3 class="mt-3 text-lg font-semibold leading-6 text-white">
                  <a href="https://www.twitter.com/KungKhalifa" target="_blank">
                    <span class="absolute inset-0"></span>
                    Twitter / X Page
                  </a>
                </h3>
